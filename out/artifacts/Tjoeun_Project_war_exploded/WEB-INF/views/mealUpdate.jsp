...
<body class="is-preload">
	<div id="wrapper">
		<div id="main">
			<div class="inner">
				...
				<form action="mealUpdateOK" method="post" enctype="multipart/form-data">
					<table class="table" style="width: 900px; margin-left: auto; margin-right: auto;">
						<tr align="center">
							<th colspan="2">식단표 수정</th>
						</tr>
						<tr>
	...
	<script src="js/fileExtensionCheck.js"></script>
</body>
</html>