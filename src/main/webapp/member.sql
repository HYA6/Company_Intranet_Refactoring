...
SELECT * FROM member ORDER BY cnum DESC;
SELECT COUNT(*) FROM member;

INSERT INTO member (cnum, name, joiningdate, team, role, email, phone, birthday, dayoff, password)
...
DELETE FROM member WHERE cnum = 220;

INSERT INTO member (cnum, name, joiningdate, team, role, email, phone, birthday, dayoff, password)
VALUES (200, '관리자', '221222', '경영진', 'ADMIN', 'j@a', '010-1111-1111', '000000', 15, '1234');
SELECT * FROM member WHERE team = '총무';
